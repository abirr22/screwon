...
<?php
                    ...
                    $i=0;
                        foreach ($Evenements as $Evenement) {
                            if (($Evenement['idEvenement'] >2)  && ($Evenement['idEvenement'] <5)) {
                         $i++;
    ...
    ?>
                ...
                <div div="row">
                    <ul class="pagination pagination-lg justify-content-end">
                        <li class="page-item ">
                            <a class="page-link  rounded-0 mr-3 shadow-sm border-top-0 border-left-0" href="afficherEvenement1.php" tabindex="-1">1</a>
                        </li>
                        <li class="page-item disabled">
                            <a class="page-link active rounded-0 mr-3 shadow-sm border-top-0 border-left-0 text-dark" href="afficherEvenement2.php">2</a>
                        </li>
                        <li class="page-item">

    ...
    <div class="dashboard-main-wrapper">
        ...
        <center><h2>                </h2></center>
			...
			<tr>
				...
				<td>
					<a href="supprimerParticipant.php?idParticipant=<?php echo $Participant['idParticipant']; ?>">Supprimer</a>
				</td>
			</tr>
			<?php
				}
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="Participant.html" data-toggle="collapse" aria-expanded="false" data-target="#submenu-5" aria-controls="submenu-5"><i class="fas fa-fw fa-table"></i>Evenements</a>
                                <div id="submenu-5" class="collapse submenu" style="">
                                    ...
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="Participant.php" data-toggle="collapse" aria-expanded="false" data-target="#submenu-5-3" aria-controls="submenu-5-3"><i class="fas fa-fw fa-table"></i>Envoyer e_mail</a>
                                        </li>   
                                    </ul>
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="Participant.php" data-toggle="collapse" aria-expanded="false" data-target="#submenu-5-4" aria-controls="submenu-5-4"><i class="fas fa-fw fa-table"></i>Taux de participation</a>
                                        </li>   
                                    </ul>
                                </div>
                            </li>

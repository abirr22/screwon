...
<html lang="en">
  <head>
    <title>Tayarni Shop - Product Detail Page</title>
    <meta charset="utf-8" />
...
-->
  ...
  include 'avionC.php';
	$avionC=new AvionC();
	$avion=$avionC->rechercherAvion($id);
    ?>
    <!-- Start Top Nav -->
      ...
      <div class="container pb-5">
        <div class="row">
                    ...
                    <div class="row">
                      <div class="col-4">
                        <a href="#">
                          <img
                            class="card-img img-fluid"
                            src="assets/img/<?php echo $avion['img2']; ?>"
                            alt="Product Image 1"
                          />
                        </a>
                      </div>
                      <div class="col-4">
                        <a href="#">
                          <img
                            class="card-img img-fluid"
                            src="assets/img/<?php echo $avion['img3']; ?>"
                            alt="Product Image 2"
                          />
                        </a>
                      </div>
                      <div class="col-4">
                        <a href="#">
                          <img
                            class="card-img img-fluid"
                            src="assets/img/<?php echo $avion['img4']; ?>"
                            alt="Product Image 3"
                          />
                        </a>
                      </div>
          ...
          <div class="col-lg-7 mt-5">
            <div class="card">
              <div class="card-body">
                <h1 class="h2"><?php echo $avion['nom']; ?></h1>
                <p class="h3 py-2"><?php echo $avion['prix']; ?> DT</p>
                <p class="py-2">
                ...
                <ul class="list-inline">
                  ...
                  <li class="list-inline-item">
                    <p class="text-muted"><strong>Quatar Airways</strong></p>
                  </li>
                </ul>
                ...
                <ul class="list-inline">
                  ...
                  <li class="list-inline-item">
                    <p class="text-muted"><strong>rouge</strong></p>
                  </li>
                </ul>

...
if (isset($_POST['nom'] ) && isset($_POST['prenom'] )&& isset($_POST['job'] )&& isset($_POST['dispo'] )&& isset($_POST['idreservation'] )) 
{
        $staff = new staff(NULL , $_POST['nom'] , $_POST['prenom'] , $_POST['job'], $_POST['dispo'] , $_POST['idreservation']);
        $staffC = new staffC();
        $staffC->ajouterstaff($staff);
...
<select name='dispo' id='dispo'>
    ...
    <option value="non">non</option></td>
                                    ...
                                    <label for="idreservation">idreservation:
                            </label>
                          </td>
                          <td>
                          <label style="color:green;font-family:verdana;font-size:30px" for="idreservation">reservation:
                            ...
                            <td>
                                            </label><select name="idreservation" id="idreservation">
                              <option value="0">--if no choose an option--</option>
        ...
        <a style="margin-left:1100;" href="afficherstaff.php"  class="button button3">retour</a>

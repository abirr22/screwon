...
<!-- Header -->
      ...
      <form action="" method="post">
        <table  id="customers" style="margin-left:165px;"> 
          <tr>
            ...
            <td><a href="supprimerreservation.php?idreservation=<?php echo $reservation['idreservation'] ; ?>"><img src="../Assets/Images/supp.png" witdh='25px' height='25px'></a></td>
            <td><a class="button button2" href="modifierreservation.php?idreservation=<?php echo $reservation['idreservation'] ; ?>">modifier</a></td>
            </tr>
	...
	<div  style="display: block;margin-left: auto;margin-right: auto;margin-top: 15%;">
	  <h1 style="text-align:center;margin-left:500;">Réserver aujourd'hui et voler demain </h1>
	  <h5 style="text-align:center;margin-left:500;">Tayarni vous assure un vol confortable avec un staff hautement qualifié</h5>
	  <div style="margin-top:30px">
	  <a style="margin-left:740;" href="ajouterreservation.php"  class="button button1">Reserver</a>
      <a style="margin-left;" href="afficherreservationt.php"  class="button button2">trier</a>
	  <div>
	</div>
    </section>

...
<form  action="" method="POST" onsubmit="return verif();" >
            <table  class="aa" style="display:flex;   width: 50%; border: 3px solid green;padding: 10px;margin-left:600px;"> 
            ...
            <tr>
                    ...
                    <tr>
                                        ...
                                        <td><input type="number" name="num" id="num" maxlength="20" required></td>
                                    </tr>
                    ...
                    <tr>
                                        ...
                                        <td><input type="text" name="staff" id="staff" maxlength="20" required></td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td><input type="text" name="id" id="id" maxlength="20" required></td>
                                    </tr>
        ...
        <a style="margin-left:1100;" href="afficherback.php"  class="button button3">retour</a>

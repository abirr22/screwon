<?php
       ...
       $archive = $archiveC->afficherarchivereservation();
...
<body>
  ...
  margin-right: auto;}
          ...
          <tr>
            ...
            <td><a href="supprimerarchivereservation.php?idreservation=<?php echo $reservation['idreservation'] ; ?>"><img src="../Assets/Images/supp.png" witdh='25px' height='25px'></a></td>
            <td><a class="button button2" href="restore.php?idreservation=<?php echo $reservation['idreservation'] ; ?>">restore</a></td>
            </tr>
        
          
            <?php
										}
                 echo (" You have $i archive");	
									?>
       </div>     </table></form>    
...
<script>
    function createPDF() {
        ...
        <a style="margin-left:1100;" href="afficherback.php"  class="button button1">Retour</a>

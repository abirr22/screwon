          ...
          <ul class="list-unstyled templatemo-accordion">
            <li class="pb-3">
              ...
              <ul class="collapse show list-unstyled pl-3">
                <li>
                    <label for="customRange1" class="form-label">Prix entre 50 et 500 MDT</label>

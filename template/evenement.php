...
<body>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-wrapper">
            ...
            <center><h1>Liste des évènements</h1></center>
			...
			<tr>
				...
				<td>
					<form method="POST" action="modifierEvenement.php">
						...
						<input type="hidden" value=<?PHP echo $Evenement['nomEvenement']; ?> name="nomEvenement">
					</form>
				</td>
				<td>
					<a href="supprimerEvenement.php?nomEvenement=<?php echo $Evenement['nomEvenement']; ?>">Supprimer</a>
				</td>
			</tr>
			<?php
				}

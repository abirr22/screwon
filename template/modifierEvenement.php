<?php
    ...
    if (isset($_GET['idEvenement'] ) && isset($_POST["nomEvenement"]) &&
    ...
    isset($_POST["img"])) 
    {
            ...
            $Evenement  = new Evenement ( $_POST['nomEvenement'],
            $_POST['descriptionEvenement'], 
            $_POST['prix'],
            $_POST['temps'],
            $_POST['dateEvenement'],
            $_POST['img'],);
            $EvenementC->modifierEvenement($Evenement,$_GET['idEvenement']);
            echo $_GET['idEvenement'];
            header('Location:afficherListeEvenements.php');
    }else
    {
        $a = $EvenementC->getevenementbyID($_GET['idEvenement']) ;
    }
   ?>
...
<link rel="apple-touch-icon" href="assets/img/logo.gif">
    ...
    <!-- ============================================================== -->
    <center><h1>                </h1></center>
    <center>  <a href="afficherListeEvenements.php" class="btn btn-primary">Retour à la liste des Evenements</a></center>
    <center><h2>                </h2></center>
        <form action="" method="POST">
            <table border="1" align="center">
                <tr>
                    ...
                    <td><input type="text" name="nomEvenement" id="nomEvenement" value="<?php echo $a['nomEvenement']; ?>" maxlength="20"></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><input type="text" name="descriptionEvenement" id="descriptionEvenement" value="<?php echo $a['descriptionEvenement']; ?>" maxlength="20"></td>
                </tr>
                <tr>
                    <td>
                        <label for="prix">prix:
                    ...
                    <td>
                        <input type="number" name="prix" id="prix" value="<?php echo $a['prix']; ?>">
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="time" name="temps" id="temps" value="<?php echo $a['temps']; ?>">
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="date" name="dateEvenement" id="dateEvenement" value="<?php echo $a['DateEvenement']; ?>">
                    </td>
                </tr>  
                <tr>
                    <td>
                    ...
                    <td><input type="file" name="img" id="img" value="<?php echo $a['img']; ?>" ></td>
                </tr>                        
                <tr>
                    <td></td>
                    <td>

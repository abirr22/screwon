...
<link rel="apple-touch-icon" href="assets/img/logo.gif">
    ...
    <meta charset="utf-8">
    <meta name="viewp
    ort" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <a href="ajouterEvenement.php"   class="btn btn-primary">Ajouter un événement</a></center>
        <center><h2>                </h2></center>
        <center> <a style="margin-left:1100;" href="affichertrier.php"  class="btn btn-primary">trier</a></center>
        <center><h1>                </h1></center>
			...
			<tr>
				...
				<td>
					<a href="modifierEvenement.php?idEvenement=<?php echo $Evenement['idEvenement']; ?>">Modifier</a>
				</td>
				<td>
                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-5" class="collapse submenu" style="">
                                    ...
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="evenement.php" data-toggle="collapse" aria-expanded="false" data-target="#submenu-5-3" aria-controls="submenu-5-3"><i class="fas fa-fw fa-table"></i>Envoyer e_mail</a>
                                        </li>   
                                    </ul>
                                    <ul class="nav flex-column">
                                        <li class="nav-item">

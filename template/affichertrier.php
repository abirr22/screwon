...
<center><h1>                </h1></center>
        ...
        <center><h2>                </h2></center>
        <center> <a style="margin-left:100;" href="affichertrier.php"  class="btn btn-primary">trier</a></center>
        <center><h1>                </h1></center>                   
...
<table border="1" align="center">
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="afficherback.php" data-toggle="collapse" aria-expanded="false" data-target="#submenu-3" aria-controls="submenu-3"><i class="fas fa-fw fa-chart-pie"></i>Location</a>
        ...
        <!-- ============================================================== -->
                    ...
                    <a  href="ajouterEvenement.php"   class="btn btn-primary">Ajouter un événement</a></center>
       <!-- <a style="margin-left:1100;" href="ajouterEvenement.php" class="button button1">Ajouter un événement</a> -->

...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="asssets/vendor/bootstrap/css/bootstrap.min.css">
    <link href="asssets/vendor/fonts/circular-std/style.css" rel="stylesheet">
    <link rel="stylesheet" href="asssets/libs/css/style.css">
    <link rel="stylesheet" href="asssets/vendor/fonts/fontawesome/css/fontawesome-all.css">
    <link rel="stylesheet" href="asssets/vendor/charts/chartist-bundle/chartist.css">
    <link rel="stylesheet" href="asssets/vendor/charts/morris-bundle/morris.css">
    <link rel="stylesheet" href="asssets/vendor/fonts/material-design-iconic-font/css/materialdesignicons.min.css">
    <link rel="stylesheet" href="asssets/vendor/charts/c3charts/c3.css">
    <link rel="stylesheet" href="asssets/vendor/fonts/flag-icon-css/flag-icon.min.css">
    <title>Tayarni </title>
                ...
                <div class="collapse navbar-collapse " id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto navbar-right-top">
                                        ...
                                        <div class="list-group">
                                            <a href="#" class="list-group-item list-group-item-action active">
                                                <div class="notification-info">
                                                    <div class="notification-list-user-img"><img src="asssets/images/avatar-2.jpg" alt="" class="user-avatar-md rounded-circle"></div>
                                            ...
                                            <a href="#" class="list-group-item list-group-item-action">
                                                <div class="notification-info">
                                                    <div class="notification-list-user-img"><img src="asssets/images/avatar-3.jpg" alt="" class="user-avatar-md rounded-circle"></div>
                                            ...
                                            <a href="#" class="list-group-item list-group-item-action">
                                                <div class="notification-info">
                                                    <div class="notification-list-user-img"><img src="asssets/images/avatar-4.jpg" alt="" class="user-avatar-md rounded-circle"></div>
                                            ...
                                            <a href="#" class="list-group-item list-group-item-action">
                                                <div class="notification-info">
                                                    <div class="notification-list-user-img"><img src="asssets/images/avatar-5.jpg" alt="" class="user-avatar-md rounded-circle"></div>
                                ...
                                <li class="connection-list">
                                    <div class="row">
                                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">
                                            <a href="#" class="connection-item"><img src="asssets/images/github.png" alt="" > <span>Github</span></a>
                                        </div>
                                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">
                                            <a href="#" class="connection-item"><img src="asssets/images/dribbble.png" alt="" > <span>Dribbble</span></a>
                                        </div>
                                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">
                                            <a href="#" class="connection-item"><img src="asssets/images/dropbox.png" alt="" > <span>Dropbox</span></a>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">
                                            <a href="#" class="connection-item"><img src="asssets/images/bitbucket.png" alt=""> <span>Bitbucket</span></a>
                                        </div>
                                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">
                                            <a href="#" class="connection-item"><img src="asssets/images/mail_chimp.png" alt="" ><span>Mail chimp</span></a>
                                        </div>
                                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">
                                            <a href="#" class="connection-item"><img src="asssets/images/slack.png" alt="" > <span>Slack</span></a>
                                        </div>
                                    </div>
                                </li>
                                <li>
                        ...
                        <li class="nav-item dropdown nav-user">
                            <a class="nav-link nav-user-img" href="#" id="navbarDropdownMenuLink2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="asssets/images/avatar-1.jpg" alt="" class="user-avatar-md rounded-circle"></a>
                                ...
                                <tbody>
                                  <?php  foreach($listeavion as $avion){ //boucle for bch tparcouri tableau o yaffichili a chaque fois les donnes li fih  ?>  
                                    <tr>
                                        ...
                                        <a href="supprimer_avion.php?id=<?php echo $avion['id']; ?>" onclick="return(confirm('Etes-vous sûr de vouloir supprimer cette entrée?'));" class="btn btn-danger">Supprimer</a>
                                    </td>
...
<div class="pagination">
  ...
  <a href="afficherback2.php">&raquo;</a>
    ...
    <!-- Optional JavaScript -->
    <!-- jquery 3.3.1 -->
    <script src="asssets/vendor/jquery/jquery-3.3.1.min.js"></script>
    <!-- bootstap bundle js -->
    <script src="asssets/vendor/bootstrap/js/bootstrap.bundle.js"></script>
    <!-- slimscroll js -->
    <script src="asssets/vendor/slimscroll/jquery.slimscroll.js"></script>
    <!-- main js -->
    <script src="asssets/libs/js/main-js.js"></script>
    <!-- chart chartist js -->
    <script src="asssets/vendor/charts/chartist-bundle/chartist.min.js"></script>
    <!-- sparkline js -->
    <script src="asssets/vendor/charts/sparkline/jquery.sparkline.js"></script>
    <!-- morris js -->
    <script src="asssets/vendor/charts/morris-bundle/raphael.min.js"></script>
    <script src="asssets/vendor/charts/morris-bundle/morris.js"></script>
    <!-- chart c3 js -->
    <script src="asssets/vendor/charts/c3charts/c3.min.js"></script>
    <script src="asssets/vendor/charts/c3charts/d3-5.4.0.min.js"></script>
    <script src="asssets/vendor/charts/c3charts/C3chartjs.js"></script>
    <script src="asssets/libs/js/dashboard-ecommerce.js"></script>
    <script>

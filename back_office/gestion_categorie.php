                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="id-categorie" class="form-control" id="input-id-categorie">

                                    <small id="input-id-categorie-error" class="form-text text-danger d-none">veuillez entrer votre Id</small>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table">
                                ...
                                <tbody>
                                  <?php  foreach($listcategorie as $categorie){ //boucle for ?>  
                                    <tr>
...
$( document ).ready(function() {  //fonction trecuperi valeur fi west champs id o amalt test est ce que le champs adheka vide wale 
    ...
    { 
         var inputId= $('#input-id-categorie').val();
        
        
        if (inputId!=''&& parseInt(inputId)>0)
        {  
            
            document.getElementById('input-id-categorie-error').classList.add('d-none')
            $('#btn-submit').attr('disabled',false); //bloukit l boutton 
        }
        else
         {
            $('#btn-submit').attr('disabled',true);
            document.getElementById('input-id-categorie-error').classList.remove('d-none')
